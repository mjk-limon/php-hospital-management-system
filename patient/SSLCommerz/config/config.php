...
return [
    ...
    'success_url' => 'patient/payment_callback.php',
    'failed_url' => 'patient/payment_callback.php',
    'cancel_url' => 'patient/payment_callback.php',
    'ipn_url' => 'patient/payment_callback.php',
];
