												...
												<tr>
													...
													<td>
														...
														<div style="margin-top: 10px;">
															<a href="javascript:;" onclick="$(this).find('+ .doctorcontact').slideToggle()">View Doctor Contact</a>
															<div class="doctorcontact" style="display: none;">
																<h5 style="font-weight: bold;font-size: 16px;"><?php echo $row3["doctorName"] ?></h5>
																<p><strong>Mobile</strong>: <?php echo $row3['contactno'] ?></p>
																<p><strong>Email</strong>: <?php echo $row3['docEmail'] ?></p>
																<p><strong>Address</strong>: <?php echo $row3['address'] ?></p>

																<style scoped>
																	.doctorcontact {padding: 1rem 0;}
																	.doctorcontact p {margin-bottom: 3px;}
																</style>
															</div>
														</div>
													</td>
