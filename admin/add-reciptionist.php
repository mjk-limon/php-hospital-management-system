					...
					<div class="wrap-content container" id="container">
						...
						<div class="container-fluid container-fullw bg-white">
									...
									<div class="row margin-top-30">
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
					                         ...
					                         <input type="text" name="recname" class="form-control"  placeholder="Enter reciptionist Name">
														</div>
                          ...
                          <div class="form-group">
					                       ...
					                       <textarea name="address" class="form-control"  placeholder="Enter reciptionist Address"></textarea>
													</div>
                          ...
                          <div class="form-group">
					                        ...
					                        <input type="text" name="reccontact" class="form-control"  placeholder="Enter reciptionist Contact no">
													</div>
